...
const students = [
  ...
  { name: "Rahul M.", pkg: "24 LPA", role: "DevOps Eng. at Amazon", college: "IIT Delhi" },
  ...
  { name: "Vikram S.", pkg: "21 LPA", role: "Site Reliability Eng. at Uber", college: "VIT Vellore" },
  { name: "Riya M.", pkg: "12 LPA", role: "Software Eng. at Infosys", college: "MIT Pune" },
  { name: "Kunal D.", pkg: "45 LPA", role: "AI Researcher at OpenAI", college: "IIT Madras (Chennai)" },
  ...
  { name: "Rohit F.", pkg: "35 LPA", role: "Senior SDE at Netflix", college: "IIIT Delhi" },
    ...
    <section id="training" className="section" style={{ position: 'relative', overflow: 'hidden', backgroundColor: 'var(--color-bg-primary)' }}>
      <div className="container">
        <div className="section-header" style={{ textAlign: 'center', marginBottom: '4rem' }}>
          ...
          <h2 style={{ fontSize: '3.5rem', marginBottom: '1rem' }}>Get Industrial Training Done From Us</h2>
        ...
        <div className="student-wall" style={{ padding: '4rem 2rem', backgroundColor: 'rgba(100, 150, 255, 0.05)', borderRadius: '24px', border: '1px solid var(--color-border)' }}>
          ...
          <div className="student-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1.5rem' }}>
            {visibleStudents.map((student, idx) => (
              ...
              >
                <div style={{ position: 'absolute', top: 0, right: 0, background: 'var(--gradient-primary)', color: '#fff', padding: '0.25rem 1rem', borderBottomLeftRadius: '12px', fontWeight: 'bold' }}>
                  {student.pkg}
                </div>
        ...
        <div style={{ textAlign: 'center', marginTop: '4rem' }}>
          <button className="btn btn-primary" style={{ padding: '1.25rem 3rem', fontSize: '1.2rem', display: 'inline-flex', alignItems: 'center', gap: '0.5rem' }}>
